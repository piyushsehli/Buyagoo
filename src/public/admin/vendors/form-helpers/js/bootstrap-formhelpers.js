...
/* ==========================================================
 * bootstrap-formhelpers-slider.blade.php.js
 * https://github.com/vlamanna/BootstrapFormHelpers
 * ==========================================================
 * Copyright 2012 Vincent Lamanna
 *
...
+function ($) {
  ...
  BFHSlider.prototype = {
    ...
    initSlider: function() {
      ...
      this.$element.html(
        '<input type="hidden" name="' + this.options.name + '" value="">' +
        '<div class="bfh-slider.blade.php-handle"><div class="bfh-slider.blade.php-value"></div></div>'
      );
    ...
    updateHandle: function(val) {
      ...
      this.$element.find('.bfh-slider.blade.php-handle').css('left', positionX + 'px');
      this.$element.find('.bfh-slider.blade.php-value').text(val);
    },
  ...
  $(document).ready( function () {
    $('div.bfh-slider.blade.php').each(function () {
      var $slider;
